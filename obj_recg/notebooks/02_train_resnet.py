...
# MAGIC
# MAGIC Two-stage family, ResNet-50 FPN backbone. Trains every spec in the resnet
# MAGIC family: `resnet_detect` (Faster R-CNN), `resnet_pose` (Keypoint R-CNN, 17
# MAGIC keypoints), and `fast_rcnn_detect` (Fast R-CNN, external proposals).
...
for k, v in {"catalog": "rpeng_upleveling", "project": "seeing_models",
             ...
             "gpu_type": "A10", "model_family": "resnet", "sport": "golf"}.items():
